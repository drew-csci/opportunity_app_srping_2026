...
from .models import (
    Achievement, Opportunity, Application,
    StudentOpportunity, OrganizationFollow,
    Notification, VolunteerProfile, VolunteerExperience,
    Message,
)
from .forms import (
    AchievementForm, OpportunityForm,
    VolunteerProfileForm, VolunteerExperienceForm,
    MessageReplyForm,
)
...
def organization_applications(request):
    """View for organizations to see all applications submitted to their volunteer opportunities."""
...
def review_application(request, application_id):
    """View for organizations to review and manage a specific application."""
    if not hasattr(request.user, 'user_type') or request.user.user_type != 'organization':
        return redirect('screen1')
...
# ---------------------------------------------------------------------------
# Organization Profile & Follow Views
# ---------------------------------------------------------------------------
